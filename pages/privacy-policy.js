        ...
        <Layout
            ...
            <div className={styles.root}>
                <div className={styles.container}>
                    ...
                    <p>{`(We are not a company and this is a personal website) Here is our
                        information and contact details:`}</p>
                    <p>
                      <span>{`Jonathan Eduardo Freire Espinoza`}</span>
                      <br></br>
                    ...
                    <p>{`You can contact us using either a contact form provided on our website or by email using the following email address: jonathan.freireespinoza@gmail.com`}</p>
                    <p>{`If you contact us using the contact form, the data you enter in the input mask will be sent to us and saved when you send them. The following data will be saved:`}</p>
                    <ul>
                      <li>{`Name`}</li>
                      <li>{`Email address`}</li>
                      <li>{`Free text box for the message`}</li>
                      <li>{`Date and time when the contact was sent`}</li>
                      <li>{`Date and time when the Privacy Policy was accepted`}</li>
                      <li>{`Sending IP address`}</li>
                    </ul>
                    <p>{`Before you send the completed contract form, your consent to our processing the data is obtained, and reference is made to this privacy policy.`}</p>
                    <p>{`Furthermore, you can contact us using the provided email address. In this case, your personal data submitted with the email will be saved.`}</p>
                    <p>{`We are the data controller. The messages via email or using the contact form are sent, using Sendgrid as our service of email delivery, to our Gmail account. Read the `}<a href="https://www.twilio.com/legal/privacy" target="_blank" rel="noreferrer">{`Sendgrid's privacy policy`}</a></p>
                    <p>{`Your data will be processed exclusively to handle your concern. In the event that you contact us by email, this also comprises the required legitimate interest in processing the data. The other personal data processed when you send your query are used to prevent any abuse of the contact form and ensure the security of our information technology systems.`}</p>
                    <p>{`The data will be erased when they are no longer required to achieve the purpose for which they were collected, in other words when the conversation with you, the user, is ended or the matter has been fully clarified.`}</p>
                    <p>{`You have the opportunity at any time to revoke your consent for processing the personal data. In this case, please contact us by using the contact details in this Policy`}</p>
                    ...
                    <p>{`Complaints`}</p>
                    <p>{`You can always lodge a complaint with a European data protection authority, for example the `}<a href="https://www.datenschutz-berlin.de/wirtschaft-und-verwaltung/meldung-einer-datenpanne" target="_blank" rel="noreferrer">{`Berlin Commissioner for Data Protection and Freedom of Information`}</a></p>
